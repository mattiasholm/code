$UserPrincipalName = "mattias.holm@leroy.se"
$FirstName = "DGC"
$LastName = "Test"
$MobilePhone = "+46707800740"
$CopyGroupMembershipFrom = "andre.augustsson@leroy.se"
$OUname = "Leroy"
...
### LERÖY-SPECIFIKT:
$OnmicrosoftDomain = "leroysmogen.mail.onmicrosoft.com"
$Office365ForwardAddress = $UserPrincipalName -replace "@.*","@$OnmicrosoftDomain"
Get-ADUser -Filter {UserPrincipalName -eq $UserPrincipalName} | Set-ADUser -Add @{proxyAddresses="SMTP:$UserPrincipalName","sip:$UserPrincipalName","smtp:$Office365ForwardAddress";targetAddress="$Office365ForwardAddress"}
###
