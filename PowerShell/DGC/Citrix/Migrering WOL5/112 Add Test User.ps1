...
$LastName = $OUname
$Name = "Test.$OUname"
$UserPrincipalName = "test@$UPNSuffix"
$SamAccountName = "Test.$OUname"
...
$ErrorActionPreference = "Stop"
Get-ADUser -Filter {UserPrincipalName -eq $UserPrincipalName} | Set-ADUser -Company "$OUname" -CannotChangePassword:$True -ErrorVariable ReturnValue
