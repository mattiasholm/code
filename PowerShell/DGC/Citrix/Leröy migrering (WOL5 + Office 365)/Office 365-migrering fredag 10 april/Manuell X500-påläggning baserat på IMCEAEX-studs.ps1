$UserPrincipalName = "fredrik.viktorin@leroy.se"
$IMCEAEX = "IMCEAEX-_o=Donator_ou=Exchange+20Administrative+20Group+20+28FYDIBOHF23SPDLT+29_cn=Recipients_cn=fredrik+2Eviktorin@ondonator.se"
