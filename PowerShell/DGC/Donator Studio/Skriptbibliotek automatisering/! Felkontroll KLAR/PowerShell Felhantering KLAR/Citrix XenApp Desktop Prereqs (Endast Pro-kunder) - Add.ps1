...
$CitrixGroup = New-ADGroup -GroupCategory Security -GroupScope Global -Name "$OUname.$Group" -DisplayName "$OUname.$Group" -Path "OU=$SubOU,OU=$OUname,$OUPath" -ErrorVariable ReturnValue -PassThru
