...
{
$ReturnValue = "WARNING: Other MX record(s) with lower priority than $ReferenceNameExchange was found for $Domain. Optimal functionality cannot be guaranteed with this configuration."
}
