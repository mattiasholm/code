...
Select-Object DisplayName, Office, @{Name = "Email"; Expression = { ($_.proxyAddresses -cmatch 'SMTP:').TrimStart('SMTP:') } }, WhenCreated, @{Name = 'Licenses'; Expression = { $_.Licenses.AccountSkuId -join ', ' } } | 
