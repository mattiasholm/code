...
choco install -y git ; git config --global user.name $userName ; git config --global user.email $userEmail ; git config --global init.defaultBranch main ; git config --global push.autoSetupRemote true ; git config --global credential.helper wincred
